...
<head> 
 ...
 <body>  
		...
		<div class="socials">
			...
			<a href="https://www.instagram.com/e_sanchay/" class="fa fa-instagram"></a>
		   ...
		   <nav class="header">
			<a class="navbar-brand" href="./home.php" style="	">
				...
				<div class="headerSanch">
					<h1 style="display: inline; ">E Sanchay</h1>
				</div>
			</a>
			...
			<div class="image-wrapper">
				...
				<div class="punchline">
					<figure class="text-center">
						<blockquote class="blockquote-heading"> <p> E-SANCHAY</p> </blockquote>
							<blockquote class="blockquote">
							  <p>TRADE-IN YOUR USED <br>
								ELECTRONICS for CASH</p>
							</blockquote>
						
						<figcaption class="blockquote-footer">
							  An innovative way to <cite title="Source Title">reuse, recyle, reduce</cite>
						</figcaption>
						<a href="../Services/SellDonate.php">
							<button class="button-19" role="button">SELL/DONATE</button>
						</a>
					  </figure>
			...
			<section>
				<center>
					<h1 style="color: #3b945e; font-weight:bold; margin-top:30px; text-transform:uppercase;">Get cash in three easy steps</h1>
				</center>
			</section>
			<!-- cards start -->
				...
				<div class="card">
				  <img src="./images/images/Page 17.jpeg" class="card-img-top mx-auto" alt="...">
				  <div class="card-body">
				...
				<div class="card">
				  <img src="./images/images/Page 16.jpeg" class="card-img-top mx-auto" alt="...">
				  <div class="card-body">
					<h5 class="card-title">Pickup Facility</h5>
					<p class="card-text">We provide you with a free, trackable pre-paid shipping label for sending us your item(s).</p>
				  </div>
				</div>
				<div class="card">
				  <img src="./images/images/Page 15.jpeg" class="card-img-top mx-auto" alt="...">
				  <div class="card-body">
					<h5 class="card-title">Get Cash</h5>
			...
			<section>
        		<div class="companyimg">
					<img src="companyDet.png" alt="" srcset="" style="width:100%; height: 900px;">
        		</div>
    		</section>
