...
if($_SERVER['REQUEST_METHOD'] == "GET"){
    ...
    switch($itemName) {
        ...
        case "aircon":?>
            <h2 style="text-align:center"> AC </h2>
                  <center>
                    <img  style="width:500px; height:500px; margin-top: 20px; border-radius: 20px;" src="../Images/ProdImages/ac.jpg" alt="" srcset="" >
            ...
            case "geyser": ?>
              ...
              <center>
                <img  style="width:500px; height:500px; margin-top: 20px; border-radius: 20px;" src="../Images/ProdImages/geyser.jpeg" alt="" srcset="" >
        ...
        case "laptop": ?>
          ...
          <center>
            <img  style="width:500px; height:500px; margin-top: 20px; border-radius: 20px;" src="../Images/ProdImages/laptop.jpg" alt="" srcset="" >
    ...
    case "television": ?>
      ...
      <center>
        <img  style="width:500px; height:500px; margin-top: 20px; border-radius: 20px;" src="../Images/ProdImages/tv.jpg" alt="" srcset="" >
...
break;
        case "mobile": ?>
          ...
          <center>
            <img  style="width:500px; height:500px; margin-top: 20px; border-radius: 20px;" src="../Images/ProdImages/smartphone.jpg" alt="" srcset="" >
        ...
        case "desktop": ?>
          ...
          <center>
            <img  style="width:500px; height:500px; margin-top: 20px; border-radius: 20px;" src="../Images/ProdImages/desktop.jpg" alt="" srcset="" >
        ...
        case "printer": ?>
            ...
            case "radio": ?>
              ...
              <center>
                <img  style="width:500px; height:500px; margin-top: 20px; border-radius: 20px;" src="../Images/ProdImages/radio.jpg" alt="" srcset="" >
                  ...
                  case "hardisk": ?>
                    ...
                    <center>
                      <img  style="width:500px; height:500px; margin-top: 20px; border-radius: 20px;" src="../Images/ProdImages/harddiskjpeg" alt="" srcset="" >
